...
public class StopWatch  {
	 ...
	 *  @param milliseconds is the int input that represents minutes (0-999)
	 *
	 ...
	 *
	 *  @param seconds is the int input that represents seconds (0-59)
	 *  @param milliseconds is the int input that represents milliseconds (0-999)
	 *
	 ...
	 *  @param milliseconds is the int input that represents milliseconds (0-999)
	 *
	 * 	@throws IllegalArgumentException when milliseconds
	 * 	is not within its specified range.
	 *******************************************************************/
	...
	private static int convertToMilli(StopWatch stopWatch) {
		if (stopWatch == null)
			throw new IllegalArgumentException("convertToMilli method");
	...
	public String toString() {
		...
		return this.minutes + ":" + df2.format(this.seconds) + ":" + df3.format(this.milliseconds);
	}
	 ...
	 *  value.
	 *
	 *  @param seconds is the input that represents minutes (0-59)
	 *
	 ...
	 *  value.
	 *
	 *  @param milliseconds is the input that represents minutes (0-999)
	 *
